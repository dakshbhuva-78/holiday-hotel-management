...
<div class="col-lg-12  my-3 mt-5">
    <div class="card border-0 shadow-lg rounded-4" style="max-width: 450px; margin:auto;">
        <div class="mx-auto text h2 mt-4">Delete Rooms</div>
        <div class="card-body">
            <form action="{{ URL::to('/') }}/r_delete" class="" method="post" enctype="multipart/form-data">
                @CSRF
                <div class="form-group mt-3">
                    <input type="number" class="form-control" id="id" placeholder="Enter Id Of Room For Delete Room" name="id" value="{{ old('id') }}">
